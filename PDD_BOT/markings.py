...
markings = [
    ...
    },
    {
        ...
        "description": "обозначает пешеходный переход; стрелы разметки 1.14.2  указывают направление движения пешеходов;",
        "image": "PDD_BOT/markings/r1.14.2.png"
    },
    {
        "name": "1.14.2 Пешеходный переход",
        "description": "обозначает пешеходный переход; стрелы разметки 1.14.2  указывают направление движения пешеходов;",
    ...
    },
    {
        ...
        "image": "PDD_BOT/markings/r1.17.1.png"
    },
    {
        "name": "1.17.2 Особая",
        "description": "(цвет - желтый) - обозначает места остановок трамваев, если посадка и высадка производятся с проезжей части или с посадочной площадки, расположенной на ней;",
        "image": "PDD_BOT/markings/r1.17.2.png"
    },
    {
        "name": "1.18 Стрелка",
    ...
    },
    {
        ...
        "description": "дублирование предупреждающих дорожных знаков;",
    ...
    },
    {
        ...
        "description": "дублирование запрещающих дорожных знаков",
        "image": "PDD_BOT/markings/r1.24.3.png"
    },
    {
        "name": "1.24.4 Дублирующая",
    ...
    {
        "name": "1.24.6 Дублирующая",
        "description": "дублирование дорожного знака Фотовидеофиксация и (или) обозначение участков дороги, на которых может осуществляться фотовидеофиксация; разметка 1.24.4  может применяться самостоятельно;",
        "image": "PDD_BOT/markings/r1.24.6.png"
    },
    {
        "name": "1.24.7 Дублирующая",
        "description": "дублирование дорожного знака 8.9.3  Стоянка только транспортных средств дипломатического корпуса",
        "image": "PDD_BOT/markings/r1.24.7.png"
    },
    {
        "name": "1.25 Обозначение",
        "description": "дублирование дорожного знака 8.9.3  Стоянка только транспортных средств дипломатического корпуса",
